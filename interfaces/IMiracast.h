...
namespace WPEFramework {
    namespace Exchange {
        ...
        struct EXTERNAL IMiracast : virtual public Core::IUnknown {
            enum { ID = ID_MIRACAST};
            ...
            struct EXTERNAL INotification : virtual public Core::IUnknown {
                  ...
                  virtual void StateChange(const IMiracast::state state) = 0;
                  virtual void Exit(const uint32_t exitCode) = 0;
                  virtual void Event(const string& eventName) = 0;
            };

            virtual void Register(IMiracast::INotification* miracast) = 0;
            virtual void Unregister(IMiracast::INotification* miracast) = 0;
